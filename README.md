...
## 版本 2.3.2 更新日志  Sep 02, 2024

### 修复问题

- 【修复】上传策略文件第一次没有策略ID导致失败时，没有清空value导致第二次上传失败

### 优化功能

- 【优化】request请求上传文件返回成功请求提示增加code为0的校验

## 版本 2.3.1 更新日志  Aug 29, 2024

### 修复问题

- 【修复】header布局遮挡问题
- 【修复】编辑策略时上传文件名未清空的问题
- 【修复】做市策略tab页面【新增策略】按钮改成【新增做市策略】
- 【修复】量化策略tab页面【新增策略】按钮改成【新增策略模板】
- 【修复】新增/编辑策略模板时，策略类型先选择”套利策略“，再切换为”用户策略“，策略文件路径和策略文件名称没有切换
